...
RB.$(function() {  
  ...
  var board = RB.Factory.initialize(RB.Kanban, RB.$('#kanban'));
  RB.KanbanUpdater.start();
  ...
  // hold down shift when clicking an issue id to open it in the current tab

  
  RB.$('#kanban').delegate('.id a', 'click', function(e) {
    if (e.shiftKey) {
