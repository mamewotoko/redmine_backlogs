 ...
 * 								default: 0
 */(function(a){a.verticalFix=function(b,c){function d(){var c=parseInt(a(document).scrollTop());b.initialOffsetTop>=c?(b.css("position","absolute"),b.css("top",b.initialTop),b.css("left",0)):(b.css("position","absolute"),b.css("top",b.initialTop+a(document).scrollTop()-b.initialOffsetTop)),b.css("left",0)}b=a(b),b.cont=b.parent(),b.initialOffsetTop=parseInt(b.offset().top),b.initialTop=parseInt(b.css("top"))||0,b.containerLeft=b.cont.position().left||0,a(window).scroll(function(){a.fn.verticalFix.interval=setTimeout(function(){d()},c.delay)}),a(window).resize(function(){a.fn.verticalFix.interval=setTimeout(function(){d()},c.delay)}),d()},a.fn.verticalFix=function(b){return b=b||{},b.delay=b.delay||0,this.each(function(){new a.verticalFix(this,b)}),this}})(jQuery);